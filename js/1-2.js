...
var inputTricky = `sevenine
eighthree`

var inputFinal = `8eight1
98126
...
function run(input) {
    ...
    lines.forEach(element => {
        for (let index = 0; index < chars.length + 1; index++) {
            ...
            if (isMatchNumber(working) != undefined) {
                firstElement = isMatchNumber(working, true);
                break;
            }
        }
        ...
        for (let index = chars.length + 1; index > 0; index--) {
            ...
            if (isMatchNumber(working) != undefined) {
                console.log(isMatchNumber(working, false))
                secondElement = isMatchNumber(working, false);
                break;
            }
        }
...
function isMatchNumber(line, first) {
    matchs = [];
    ...
    if (matchs[0] != undefined) {
        return replaceNumber(matchs[0][0]);
    }
